      ...
      <View style={styles.container}>
        ...
        <View style={{ flexBasis: "auto"}}>
          ...
          <View style={{ flexDirection: "row", justifyContent:"space-between"}}>
            {Object.keys(people.social_networks).map((key) =>
        ...
        <View style={{ flexBasis: 200, justifyContent:"space-between" }}>
          <Button
            ...
            title={people.isContact === true ? "DELETE FROM CONTACTS" : "ADD TO CONTACTS"}
            style={styles.button}
            color={people.isContact === true ? "red" : "rgb(33, 150, 243)"}
          />
          <Button
            onPress={() => onAddFavourite(`${people.id}`)}
            title={people.isFavourite === true ? "DELETE FROM FAVOURITE" : "ADD TO FAVOURITE"}
            style={styles.button}
